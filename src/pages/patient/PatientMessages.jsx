...
import { FiMessageSquare, FiSearch, FiCalendar } from 'react-icons/fi'
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {loading ? (
            ...
            <div style={{ padding: '2rem 1.25rem', textAlign: 'center', color: 'var(--text-muted)', fontSize: 'var(--text-sm)', lineHeight: 1.6 }}>
              {search ? 'No doctors match your search.' : 'Doctors with confirmed appointments will appear here.'}
            </div>
          ) : (
                  ...
                  <motion.div key={c.other_user}
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {c.user?.specialization && (
                        <div style={{ fontSize: '0.65rem', color: 'var(--color-teal)', fontWeight: 600, marginBottom: '0.15rem' }}>
                          {c.user.specialization}
                        </div>
                      )}
        ...
        {activePeer ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            ...
            <EmptyState
              ...
              message="Choose a doctor from the left to open or start a conversation."
            />
          </motion.div>
        )}
      </div>
